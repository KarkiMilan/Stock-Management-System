...
<script>
    ...
    $('#pdf').click(function(){
        ...
        _el.append('<div class="d-flex justify-content-center">'+
                  ...
                  '<h3 class="text-center">Back Order</h3>'+
                  '</div>'+
                  '<div class="col-1 text-right">'+
                  '</div>'+
                  '</div><hr/>')
...
$(function(){
    $('#excel').click(function(){
        ...
        var _head = $('head').clone()
        _head.find('title').text("Back Order Details - Excel Export")
        var header = $('<div>')
        header.append(_head)
        ...
        var ctx = {worksheet: 'Back Order', table: html}
        var link = document.createElement("a")
        link.download = "back_order.xls"
