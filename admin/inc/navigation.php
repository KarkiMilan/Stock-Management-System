              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item ">
                      <a href="<?php echo base_url ?>admin/?page=analyticsseller" class="nav-link nav-analyticsseller">
                        <i class="nav-icon fas fa-fas fa-trophy"></i>
                        <p>
                         Top seller
                        </p>
                      </a>
                    ...
                    <li class="nav-item ">
                      <a href="<?php echo base_url ?>admin/?page=analyticsstock" class="nav-link nav-analyticsstock">
